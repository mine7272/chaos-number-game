...
function hideRanking() {
    ...
    // 결과 화면에서 호출했을 경우에만 body 스크롤 방지 유지
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    // 점수만 표시하는 기능으로 대체 (플레이어 이름 저장 없음)
    saveScoreButton.addEventListener('click', notifyDisabled);
...
function resetGame() {
    ...
    saveScoreButton.textContent = '기록 저장';
    // 랭킹 시스템 임시 비활성화
    // rankingScreen.classList.add('hidden');
...
// ===== 랭킹 시스템 관련 기능 - 현재 비활성화 =====

// 기능 비활성화 알림 함수 (플레이어 이름 저장 비활성화)
function notifyDisabled() {
    ...
    alert('랭킹 시스템과 플레이어 이름 저장이 일시적으로 비활성화되었습니다.');
}

// 이하 랭킹 시스템 관련 함수들은 모두 비활성화되었습니다.
/*
// 점수 저장 함수
function saveScore() {
    const playerName = playerNameInput.value.trim();
